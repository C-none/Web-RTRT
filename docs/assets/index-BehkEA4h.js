...
fn primaryHit(screen_pos: vec2u) -> PrimaryHitInfo {\r
    ...
    primaryHitInfo.motionVec = unpack2x16snorm(textureLoad(motionVec, screen_pos, 0).r);\r
...
\r
    if primaryTri.primId == 0 && all(primaryTri.baryCoord.yz == vec2f(0.0, 0.0)) {\r
