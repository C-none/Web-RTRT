...
\r
    ...
    // retInfo.metallicRoughness = vec2f(1., 0.5);\r
...
\r
            ...
            if ENABLE_GI {\r
                if reservoirPrevGI.W > 0.0 {\r
                    reservoirPrevGI.M = min(reservoirPrevGI.M, 8);\r
