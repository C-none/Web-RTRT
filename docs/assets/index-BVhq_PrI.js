...
fn main(@builtin(global_invocation_id) GlobalInvocationID: vec3u, @builtin(workgroup_id) WorkgroupID: vec3u, @builtin(local_invocation_id) LocalInvocationID: vec3u) {\r
    ...
    if depthCenter == 1.0 {\r
        ...
        variance_current[ getCoord(screen_pos)] = 100.;\r
...
\r
        if sumWeight > 0. {\r
            ...
            // sumIllum = clamp(sumIllum, illumSamp - deviation / 2, illumSamp + deviation / 2);\r
        ...
        // storeIllumination(&illumination_sample, launchIndex, vec3f(sqrt(variance) / 2));\r
...
\r
    const sigma_luminance: f32 = 0.1;\r
...
\r
        ...
        let wluminance = exp(-luminDiff * luminDiff / (sqrt(varianceCenter) * sigma_luminance + epsilon));\r
