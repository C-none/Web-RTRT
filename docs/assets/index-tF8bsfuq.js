...
\r
    ...
    if ENABLE_GI {\r
        ...
        let tracePdf = max(0.001, sampleVec.w);\r
...
\r
        ...
        if ENABLE_GI {\r
            reservoirPrevGI.M = min(reservoirPrevGI.M, 30);\r
...
\r
    ...
    for (var i = 0u; i < 5; i = i + 1u) {\r
        ...
        if neighbor_reservoirDI.W > 0. && distance(shadingPoint, neighbour_pointAttri.pos) <= 0.04 * depth && dot(pointInfo.normalShading, neighbour_pointAttri.normalShading) >= .9 {\r
            ...
            if ENABLE_GI {\r
                ...
                wo = normalize(wo);\r
                if dot(wo, pointInfo.normalShading) > 0. {\r
                    neighbor_reservoirGI.M = min(neighbor_reservoirGI.M, 256);\r
